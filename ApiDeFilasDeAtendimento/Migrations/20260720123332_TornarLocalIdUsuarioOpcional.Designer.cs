...
namespace ApiDeFilasDeAtendimento.Migrations
{
    ...
    [Migration("20260720123332_TornarLocalIdUsuarioOpcional")]
    partial class TornarLocalIdUsuarioOpcional
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApiDeFilasDeAtendimento.Models.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("ApiDeFilasDeAtendimento.Models.ConteudoPainel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("DuracaoExibicaoSegundos")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ApiDeFilasDeAtendimento.Models.TiposDeAtendimento", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("ApiDeFilasDeAtendimento.Models.ApplicationRole", null)
                        .WithMany()
